<?php 
            ...
            $max_of_10_display = 0; //Max of 10 Display.
              $query_arriving = "SELECT * FROM vessel_logs WHERE tdod IS NOT NULL ORDER BY tdoa DESC";
          ...
          <div class="card">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-dark shadow-dark border-radius-lg pt-2 pb-1">
                <h6 class="text-white text-uppercase ps-3">Departure Vessel [<?=$total_fetched_arriving?>]</h6>
              </div>
            </div>
            <div class="card-body">

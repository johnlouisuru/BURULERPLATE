...
?>
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <!-- Dito start ng BODY iwan palagi yang Contrainer-fuid-->
          ...
          <div class="card">
            <div class="card-header p-2 ps-3">
              <div class="d-flex justify-content-between">
                <div>
                  <p class="text-sm mb-0 text-uppercase text-warning">Registered Vessel</p>
                  <?php 
                    $count_all_vessel = 'SELECT * FROM vessel_details';
                    $total_registered = get_total_count($pdo, $count_all_vessel);
                  ?>
                  <h4 class="mb-0"><?=$total_registered?></h4>
                </div>
            ...
            <div class="card-footer p-2 ps-3">
              <p class="mb-0 text-sm"><span class="text-success font-weight-bolder"></span>Based on System's data.</p>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            <div class="card-header p-2 ps-3">
              <div class="d-flex justify-content-between">
                <div>
                  <p class="text-sm mb-0 text-success text-uppercase">Current Vessel</p>
                  <?php 
                    $count_all_vessel = 'SELECT * FROM vessel_logs WHERE tdod IS NULL GROUP BY vid ASC';
                    $total_current = get_total_count($pdo, $count_all_vessel);
                    $percentage = ($total_current / $total_registered) * 100;
                  ?>
            ...
            <hr class="dark horizontal my-0">
            <div class="card-footer p-2 ps-3">
              <p class="mb-0 text-sm"><span class="text-success font-weight-bolder"><?=round($percentage, 0)?>% </span>of <?=$total_registered?></p>
            </div>
          </div>
        </div>
        ...
        <div class="col-xl-3 col-sm-6">
          <div class="card">
            <div class="card-header p-2 ps-3">
              <div class="d-flex justify-content-between">
                <div>
                  <p class="text-sm mb-0 text-uppercase">Arriving Vessel</p>
                  <?php 
                    $count_all_vessel = 'SELECT * FROM vessel_logs WHERE tdod IS NOT NULL GROUP BY vid ASC';
                    $total_arriving = get_total_count($pdo, $count_all_vessel);
                    $percentage = ($total_arriving / $total_registered) * 100;
                  ?>
                  <h4 class="mb-0"><?=$total_arriving?></h4>
                </div>
                <div class="icon icon-md icon-shape bg-gradient-dark shadow-dark shadow text-center border-radius-lg">
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            <div class="card-header p-2 ps-3">
              <div class="d-flex justify-content-between">
                <div>
                  <p class="text-sm mb-0 text-uppercase text-danger">Stranded Vessel</p>
                  <?php 
                    $count_all_vessel = 'SELECT * FROM vessel_details WHERE status = 0';
                    $total_stranded = get_total_count($pdo, $count_all_vessel);
                    $percentage = ($total_stranded / $total_registered) * 100;
                  ?>
                  <h4 class="mb-0"><?=$total_stranded?></h4>
                </div>
                <div class="icon icon-md icon-shape bg-gradient-dark shadow-dark shadow text-center border-radius-lg">
                  <!-- <i class="material-symbols-rounded opacity-10">person</i> -->
                   <img src="assets/img/stranded.png" class="" width="50" height="50" alt="main_logo">
                </div>
              </div>
            </div>
            <hr class="dark horizontal my-0">
            <div class="card-footer p-2 ps-3">
              <p class="mb-0 text-sm"><span class="text-danger font-weight-bolder"><?=round($percentage, 0)?>% </span> of <?=$total_registered?></p>
            </div>
          </div>
        </div>
      ...
      <div class="row"><!-- WHOLE ROW PARA SA MGA CARDS -->
        ...
        <div class="col-lg-6 col-md-6 mt-4 mb-4">
          <div class="card ">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-dark shadow-dark border-radius-lg pt-2 pb-1">
                <h6 class="text-white text-uppercase ps-3">Monthly Vessel Traffic [2025]</h6>
              </div>
            </div>
            <div class="card-body">
              <h6 class="mb-0 ">Total Vessel Traffic per Month</h6>
              <div class="pe-2">
                <div class="chart">
          ...
          <div class="card">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-dark shadow-dark border-radius-lg pt-2 pb-1">
                <h6 class="text-white text-uppercase ps-3">Weekly Vessel Traffic [2025]</h6>
              </div>
            </div>
            <div class="card-body">
              <h6 class="mb-0 ">Total Vessel Traffic per Week</h6>
              <div class="pe-2">
                <div class="chart">
      ...
      <!-- WHOLE ROW PARA SA MGA CARDS -->
      <div class="row mb-4">

        <!-- Project Progress Card with small images in the table -->
        <div class="col-lg-8 col-md-6 mb-md-0 mb-4">
          <div class="card">
            <div class="card-header pb-0">
              <div class="row">
                <div class="col-lg-6 col-7">
                  <h6>Aton Equipment</h6>
                  <p class="text-sm mb-0">
                    <i class="fa fa-check text-info" aria-hidden="true"></i>
                    <span class="font-weight-bold ms-1">For Procurement</span> this year
                  </p>
                </div>
            ...
            <div class="card-body px-0 pb-2">
              ...
              <div class="table-responsive">
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">MSSU</th>
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">&nbsp Batteries</h6>
                          </div>
                        </div>
                      </td>
                      <td>
        ...
        <!-- Start of Tracking itong Card na to. -->
              ...
              <div class="timeline timeline-one-side">
                <div class="timeline-block mb-3">
                  ...
                  <div class="timeline-content">
                    <h6 class="text-dark text-sm font-weight-bold mb-0">₱2400, Lightstation Repair</h6>
                ...
                <div class="timeline-block mb-3">
                  ...
                  <div class="timeline-content">
                    <h6 class="text-dark text-sm font-weight-bold mb-0">Lantern Procurement</h6>
        ...
        <!-- End of Tracking itong Card na to. -->
  ...
  <script>
    ...
    new Chart(ctx, {
      type: "bar",
      data: {
        labels: ["Mon", "Tue", "Wed", "Th", "Fr", "Sat", "Sun"],
        datasets: [{
          label: "Views",
          tension: 0.4,
          borderWidth: 0,
